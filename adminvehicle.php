            ...
            <table class="content-table">
                ...
                <tbody>
                    ...
                    <tr class="active-row">
                        ...
                        <td><button type="button" class="but"><a href="editcar.php?id=<?php echo $res['CAR_ID']; ?>">UPDATE CAR</a></button></td>
                        <td><button type="button" class="but"><a href="deletecar.php?id=<?php echo $res['CAR_ID']; ?>">DELETE CAR</a></button></td>
                    </tr>
                    <?php } ?>
                </tbody>
            </table>
